    ...
    useEffect(() => {
        const cycleAnimation = () => {
            ...
            setTimeout(() => {
                ...
                setAnimationClass('animate__bounceIn');
            }, 1000); // Adjusted time for bounceOut animation

            setTimeout(() => {
                setAnimationClass('animate__bounceInLeft');
            }, 4000); // Adjusted time for displaying text before bounceOut again
        };

        const interval = setInterval(cycleAnimation, 2000); // Total cycle time: 5 seconds

        cycleAnimation(); // Run the animation cycle once immediately
